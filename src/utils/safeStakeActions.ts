...
export const getUserReward = async (config: Config, owner: Address) => {
  const res = await readContract(config, {
    abi: CONTRACT_ABI_ARY,
    address: CONTRACT_ADDRESS as Address,
...
export const approve = async (
  ...
  tokenId: number,
  amount: any,
  spenderAddress: Address = CONTRACT_ADDRESS
) => {
  toast.warning("Please wait");
  console.log(amount + "---------------------");
  console.log(spenderAddress + "--------------------");
  ...
  const appr = await writeContract(config, {
    ...
    .then(async (hash) => {
>>>>>>> 52b031f770a6371b4a5e75c514db0b6b18da8896
...
=======
export const depositHard = async (
  config: Config,
  amount: number,
  address: Address | undefined
) => {
...
=======
export const withdrawHard = async (
  config: Config,
  address: Address | undefined
) => {
  toast.warning("Please wait while withdrawing");
...
=======
export const Emerwithdraw = async (
  config: Config,
  address: Address | undefined
) => {
  toast.warning("Please wait while EmergencyWithdraw");
